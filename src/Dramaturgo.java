public class Dramaturgo extends Poeta {
    ...
    public Dramaturgo(String nombre, String apellido1, String apellido2, String pseudonimo, Sexo sexo, String nacionalidad, int diaNacimiento, int mesNacimiento, int anyoNacimiento, int diaDEP, int mesDEP, int anyoDEP, String obraCumbre) {
    ...
    public Dramaturgo(String nombre, String apellido1, String apellido2, String pseudonimo, Sexo sexo, String nacionalidad, int diaNacimiento, int mesNacimiento, int anyoNacimiento, String obraCumbre) {
    ...
    public Dramaturgo(String nombre, String apellido1, String apellido2, String obraCumbre) {
